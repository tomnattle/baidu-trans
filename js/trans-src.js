(function () {
  ...
  $("#tip-left-top").css(
    "background",
    "url(" + chrome.extension.getURL("imgs/map/tip-left-top.png") + ")"
  );
  $("#tip-top").css(
    "background",
    "url(" + chrome.extension.getURL("imgs/map/tip-top.png") + ") repeat-x"
  );
  $("#tip-right-top").css(
    "background",
    "url(" + chrome.extension.getURL("imgs/map/tip-right-top.png") + ")"
  );
  $("#tip-right").css(
    "background",
    "url(" + chrome.extension.getURL("imgs/map/tip-right.png") + ") repeat-y"
  );
  $("#tip-right-bottom").css(
    "background",
    "url(" + chrome.extension.getURL("imgs/map/tip-right-bottom.png") + ")"
  );
  $("#tip-bottom").css(
    "background",
    "url(" + chrome.extension.getURL("imgs/map/tip-bottom.png") + ") repeat-x"
  );
  $("#tip-left-bottom").css(
    "background",
    "url(" + chrome.extension.getURL("imgs/map/tip-left-bottom.png") + ")"
  );
  $("#tip-left").css(
    "background",
    "url(" + chrome.extension.getURL("imgs/map/tip-left.png") + ")"
  );
  $("#tip-arrow-bottom").css(
    "background",
    "url(" + chrome.extension.getURL("imgs/map/tip-arrow-bottom.png") + ")"
  );
  $("#tip-arrow-top").css(
    "background",
    "url(" + chrome.extension.getURL("imgs/map/tip-arrow-top.png") + ")"
  );
  var t = 12;
  var b = function (u) {
  ...
  var over = function (E) {
    ...
    if (
      srcObj.tagName &&
      srcObj.tagName.toUpperCase() === "TRANS" &&
      ...
      // }
      y.innerHTML =
        "<div style='padding:13px 13px;width: 266px;'><p>\u539f\u6587\uff1a</p><div style='width:250px;white-space:normal;'>" +
        srcObj
          .getAttribute("data-src")
          .replace("<", "&lt;")
          .replace(">", "&gt;") +
        "</div><div><img src='" +
        chrome.extension.getURL("imgs/map/logo.png") +
    ...
    $("#check_in_fanyi_baidu_com_" + over_count).on("click", function () {
      chrome.runtime.sendMessage(
        { category: "guide", action: "guide_fanyi_tip", opid: 3 },
        function (response) {}
      );
      window.open(
        "http://fanyi.baidu.com/#auto/zh/" + srcObj.getAttribute("data-src")
      );
    });
    over_count += 1;
  };
