...
(function(b) {
    ...
    a.src = b + '&rnd=' + r
})('http://hm.baidu.com/hm.gif?si=3b231847743b9335bfaccda43a1abc1b&et=0&nv=0&st=4&v=pixel-1.0');
...
var trackPageview = function (url) {
    ...
    var logUrl = 'http://hm.baidu.com/hm.gif?si=3b231847743b9335bfaccda43a1abc1b&et=0&nv=0&st=4&v=pixel-1.0&u='
...
var trackEvent = function (category, action, opt_label, opt_value) {
    ...
    var logUrl = 'http://hm.baidu.com/hm.gif?si=3b231847743b9335bfaccda43a1abc1b&et=0&nv=0&st=4&v=pixel-1.0&et=4&ep='
